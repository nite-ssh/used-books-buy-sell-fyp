...
import { NestedEnumBookStateEnumWithAggregatesFilter } from "./NestedEnumBookStateEnumWithAggregatesFilter";
import { NestedIntFilter } from "./NestedIntFilter";
import { BookStateEnum } from "../../enums/BookStateEnum";

@TypeGraphQL.InputType("EnumBookStateEnumWithAggregatesFilter", {
  isAbstract: true
})
export class EnumBookStateEnumWithAggregatesFilter {
