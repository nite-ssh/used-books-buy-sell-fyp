...
@TypeGraphQL.InputType("BookUnverifiedCreateWithoutBookStateInput", {
  isAbstract: true,
})
export class BookUnverifiedCreateWithoutBookStateInput {
  ...
  @TypeGraphQL.Field(
    (_type) => BookCategoryCreateNestedOneWithoutBookUnverifiedInput,
    {
      nullable: false,
    },
  )
  ...
  @TypeGraphQL.Field(
    (_type) => TransactionCreateNestedManyWithoutBookUnverifiedInput,
    {
      nullable: true,
    },
  )
  transaction?:
    | TransactionCreateNestedManyWithoutBookUnverifiedInput
    | undefined;
}
