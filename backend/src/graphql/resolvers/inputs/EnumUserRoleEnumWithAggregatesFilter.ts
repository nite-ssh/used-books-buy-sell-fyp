...
import { NestedEnumUserRoleEnumWithAggregatesFilter } from "./NestedEnumUserRoleEnumWithAggregatesFilter";
import { NestedIntFilter } from "./NestedIntFilter";
import { UserRoleEnum } from "../../enums/UserRoleEnum";

@TypeGraphQL.InputType("EnumUserRoleEnumWithAggregatesFilter", {
  isAbstract: true
})
export class EnumUserRoleEnumWithAggregatesFilter {
